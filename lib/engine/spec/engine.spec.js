...
describe("Game Engine", function () {
    ...
    describe("LocationFactory", function () {
        ...
        it("Build new location", function () {
            // act
            var l = factory["new"]().id("l1").set_state("state").set_text("state", "text").set_text("state2", "text2").add_link("l2", "l2text", "state3").add_link("l3", "l3text") // default state
            .build();
            // assert
        ...
        it("Alter existing location", function () {
            // arrange
            var l = new LocationFactory()["new"]().id("l1").set_state("state").set_text("state", "text").set_text("state2", "text2").add_link("l2", "l2text", "state3").add_link("l3", "l3text") // default state
            .build();
            // act
    ...
    describe("Logical Conditions AND", function () {
        ...
        var c_true = { is_valid: function is_valid(engine) {
                return true;
            } };
        var c_false = { is_valid: function is_valid(engine) {
                return false;
            } };
    ...
    describe("EventHandler", function () {
        ...
        var DummyAction = function DummyAction() {
            this.executed = false;
